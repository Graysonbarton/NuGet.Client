...
namespace NuGet.Commands.Test.RestoreCommandTests
{
    ...
    public class RestoreCommandTests
    {
        ...
        public async Task ExecuteAsync_WithSinglePackage_PopulatesCorrectTelemetry()
        {
            ...
            packageSpec.TargetFrameworks[0].NuGetAudit.EnableAudit = bool.TrueString;
            packageSpec.TargetFrameworks[0].NuGetAudit.SuppressedAdvisories = new HashSet<string> { "https://cve-1" };
